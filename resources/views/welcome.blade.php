...
<head>
    ...
    <link rel="stylesheet" href="{{('public/frontend/css/gijgo.css')}}">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="{{('public/frontend/images/destination/1.png')}}" alt="">
                        </div>
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="{{('public/frontend/images/place/1.png')}}" alt="">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="{{('public/frontend/images/svg_icon/1.svg')}}"" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="{{('public/frontend/images/svg_icon/2.svg')}}"" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="{{('public/frontend/images/svg_icon/3.svg')}}"" alt="">
                        </div>
                        <h3>Travel Guide</h3>
                        <p>A wonderful serenity has taken to the possession of my entire soul.</p>
                    </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="{{('public/frontend/images/testmonial/author.png')}}" alt="">
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        <div class="thumb">
                            <img src="{{('public/frontend/images/trip/1.png')}}" alt="">
                        </div>
                        <div class="info">
                            <div class="date">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        <div class="thumb">
                            <img src="{{('public/frontend/images/trip/2.png')}}" alt="">
                        </div>
                        <div class="info">
                            <div class="date">
                                <span>Oct 12, 2019</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        <div class="thumb">
                            <img src="{{('public/frontend/images/trip/3.png')}}" alt="">
                        </div>
                        <div class="info">
                            <div class="date">
                                <span>Oct 12, 2019</span>
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="{{('public/frontend/images/footer_logo.png')}}" alt="">
                                </a>
                            </div>
                        ...
                        <div class="footer_widget">
                            ...
                            <div class="instagram_feed">
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="{{('public/frontend/images/instagram/1.png')}}" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="{{('public/frontend/images/instagram/2.png')}}" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="{{('public/frontend/images/instagram/3.png')}}" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="{{('public/frontend/images/instagram/4.png')}}" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="{{('public/frontend/images/instagram/5.png')}}" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="{{('public/frontend/images/instagram/6.png')}}" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
...
<!--     
    ...
    <script src="{{('public/frontend/js/gijgo.min.js')}}"></script>
