      ...
      <table class="table table-striped b-t b-light">
		...
		@foreach($all_category_product as $cate_pro)
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-category-product-'.$cate_pro->category_id)}}" class="acctive styling-edit" ui-toggle-class="">
              	<i class="fa fa-pencil-square-o text-success text-active"></i></a>
              <a onclick="return confirm('Bạn có muốn xóa danh mục sản phẩm?')" href="{{URL::to('/delete-category-product-'.$cate_pro->category_id)}}" class="acctive styling-edit" ui-toggle-class="">
