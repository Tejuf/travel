	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
					...
					if($name)
						echo '<span class="profile-usertitle-name">'.$name.'</span>';
					?>
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-navicon">&nbsp;</em> Tour Du Lich <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-1">
					<li><a class="" href="{{URL::to('/all-tour')}}">
						<span class="fa fa-arrow-right">&nbsp;</span> Liệt Kê Tour
					</a></li>
					<li><a class="" href="{{URL::to('/add-tour')}}">
						<span class="fa fa-arrow-right">&nbsp;</span> Thêm Tour
					</a></li>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-2">
				<em class="fa fa-navicon">&nbsp;</em> Danh Mục Sản Phẩm <span data-toggle="collapse" href="#sub-item-2" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-2">
					<li><a class="" href="{{URL::to('/all-category-product')}}">
						<span class="fa fa-arrow-right">&nbsp;</span> Liệt Kê Danh Mục Sản Phẩm
					</a></li>
					<li><a class="" href="{{URL::to('/add-category-product')}}">
						<span class="fa fa-arrow-right">&nbsp;</span> Thêm Danh Mục Sản Phẩm
					</a></li>
